...
int fsrPin1 = A1;     // the FSR and 10K pulldown are connected to a0
...
void loop(void) {
  ...
  Serial.print(fsrReading);    Serial.print(",");  // the raw analog reading

  fsrReading2 = analogRead(fsrPin1);

  //Serial.print("Analog2 reading = "); Serial.print(",");
  Serial.print(fsrReading2);   Serial.print(",");  // the raw analog reading

  fsrReading3 = analogRead(fsrPin2);

  //Serial.println("Analog3 reading = ");
